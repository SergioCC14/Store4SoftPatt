 ...
 * @author Daniel
 */
public class ConsultarListaTecnicos extends javax.swing.JFrame {

    /**
     * Creates new form InicioSesion
     */
    public ConsultarListaTecnicos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID.", "Nombre", "T. Realizados", "Contratado"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarListaTecnicos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultarListaTecnicos().setVisible(true);
            }
        });
    }
