...
public class ConsultarListaPedidos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"1", "Pagado", "x", "x.xx€", "12/34/5678"},
                {"2", "Enviado", "y", "y.yy€", "23/45/6789"}
            },
            new String [] {
                "ID.", "Estado", "Cantidad Artículos", "Coste", "Fecha"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarListaPedidos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultarListaPedidos().setVisible(true);
            }
        });
    }
