 ...
 */
public class ConsultarListaProveedores extends javax.swing.JFrame {

    /**
     * Creates new form InicioSesion
     */
    public ConsultarListaProveedores() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID.", "Nombre", "Pedidos Realizados", "Artículos asociados"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarListaProveedores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultarListaProveedores().setVisible(true);
            }
        });
    }
